...
{
    public class DetalleFactoresNetosComisionVariableViewModel : EncabezadoModeloComisionViewModel
    {
        ...
        public List<FactorNetoComisionVariableViewModel> FactoresComision { get; set; }
        ...
        [Required(ErrorMessage = "Se requiere el factor"), Range(0.001, int.MaxValue, ErrorMessage = "Debe ser un valor mayor a 0")]
        public decimal FactorIngresado { get; set; }
        [Required]
        public EstadoBeneficiario ClasificacionRecaudo { get; set; }

        public DetalleFactoresNetosComisionVariableViewModel()
        {
            this.FactoresComision = new List<FactorNetoComisionVariableViewModel>();
    ...
    public class FactorNetoComisionVariableViewModel
    {
