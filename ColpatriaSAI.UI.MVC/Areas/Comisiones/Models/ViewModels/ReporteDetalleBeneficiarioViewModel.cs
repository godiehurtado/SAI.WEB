...
{
    public class ReporteDetalleBeneficiarioViewModel
    {
        ...
        public List<Componentes.Comision.Reportes.ReporteDetalleBeneficiariosClass> lDatos;

        public ReporteDetalleBeneficiarioViewModel()
        {
            ...
            this.lDatos = new List<Componentes.Comision.Reportes.ReporteDetalleBeneficiariosClass>();
        }
    }
}