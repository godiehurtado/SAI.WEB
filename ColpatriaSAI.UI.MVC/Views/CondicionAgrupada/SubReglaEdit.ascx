 ...
 <table id="tablaLista7">
        ...
        <tbody>
            ...
            <% foreach (var item in ((IEnumerable<SubRegla>)ViewData["SubReglas"]))
               { %>
            <tr>
                <td align="center"><%: Html.RadioButton("seleccionSubReglaEdit", item.id, new { @onclick = "seleccionarSubReglaEdit(" + item.id + ", \"" + item.descripcion + "\")" })%></td> 
