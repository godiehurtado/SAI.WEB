...
<script type="text/javascript">
    ...
    function validarCombinaciones() {
        ...
        //Compañía (C) – Línea de negocio (Ln) - Ramo (R) - negocio (N) - producto (P) - poliza (Po) - participante (Pa) - (localidad (Lo): ESTA NO VA) - codigoagrupador (Ca), Tipo Vehiculo (T)
        var combinaciones = { "CLnRPPa": "111010100", "CRPPa": "101010100", "CLnRNP": "111110000", "CLnRP": "111010000", "CLnCa": "110000010", "CLnR": "111000000", "CLn": "110000000", "CLnPa": "110000100","CRPPa": "101010100","CRPN": "101110000","CRP": "101010000","CR": "101000000","CCa": "100000010","CPa": "100000100","C":"100000000","CRPT":"101010001"};
        
        var combinacionActual = "";
        var resultado = false;

        var compania = "0", lineaNegocio = "0", ramo = "0";
        var negocio = "0", producto = "0", poliza = "0", participante = "0", agrupador = "0", tipoVehiculo = "0";
        ...
        if ($("#TipoVehiculo").val() != 0 && $("#TipoVehiculo").val() != null) tipoVehiculo = "1";

        combinacionActual = compania + lineaNegocio + ramo + negocio + producto + poliza + participante + agrupador + tipoVehiculo;
	 ...
	 <legend>Detalle excepción</legend>
		<table cellspacing="2" width="100%" border="0">
			...
			<tr>
                ...
                <td>
                    <%: Html.DropDownList("TipoVehiculo", this.Model.TipoVehiculoList, "Seleccione un Valor", new { style = "width:300px;", id = "TipoVehiculo" })%>                    
                    <%: Html.Hidden("poliza")%>
                </td>
			</tr>
			<tr>
				...
				<td>                   
                    ...
                    <a href="javascript:mostrarDialogParticipantes('<%: ruta %>Participantes?r=<%: num %>&localidad_id=<%=ViewBag.localidadId %>', 'Participantes', 'dialogEditar');" style='float:left;' title='Buscar Participantes'><span class='ui-icon ui-icon-search'/></a>
			...
			<tr>
				<td colspan="4" align="center">
                    ...
                    <input type="hidden" name="excepcionRecaudo" id="excepcionRecaudo" value="0"/>
