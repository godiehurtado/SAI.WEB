...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Unidades de Medida</h2>
     ...
     <p><a href="../TipoUnidadMedida">Tipo Unidad de Medida</a></p>
    ...
    <table id="tablaAdmin">
        <tr valign="top">
            <td>
                ...
                <% using (Html.BeginForm("Crear", "UnidadMedida", FormMethod.Post, new { id = "formUnidadMedida" }))
                   {
      ...
      <% Random random = new Random();
                ...
                <% foreach (var item in ((IEnumerable<UnidadMedida>)ViewData["UnidadMedidas"]))
                   { %>
                    <tr>
                        <td align=center>
